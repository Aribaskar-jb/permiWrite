...
let userSchema = object({
    ...
    //     .required('Required'),
        ...
        .max(50)
        .required('Required'),
        fromDate: string() .max(10) .matches(/^[0-9/]*$/, 'only "DD/MM/YYYY"'),
    // Description: string()
...
export default function Letter() {
    ...
    return(
            <Formik
            initialValues={{ fullName: '', Description: '', rollNo: '', fromDate: '', toDate: '' }}
                ...
                <View style={styles.overAll}>
                    ...
                    <View style = {styles.parentView}>
                        <View style = {styles.containedView1}>
                            ...
                            <TextInput onChangeText={handleChange('fromDate')}
                        ...
                        <View style = {styles.containedView2}>
                            ...
                            <TextInput onChangeText={handleChange('toDate')}
